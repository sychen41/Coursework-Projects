...
%token   T_While T_For T_If T_Else T_Return T_Break T_PSwitch  
...
%type <stmt>	Stmt CaseStmt SwitchStmt
...
Expr		:   LValue '=' Expr		{ $$ = new AssignExpr($1, new Operator(@2, "="), $3); }
		...
		|   T_This			{ $$ = new This(@1); }
		|   Call
		|   Expr T_Pincrement		{ $$ = new PostfixExpr($1, new Operator(@2, "++")); }
		|   Expr T_Pdecrement		{ $$ = new PostfixExpr($1, new Operator(@2, "--")); }
		|   '(' Expr ')'		{ $$ = $2; }
...
SwitchStmt: T_PSwitch '(' T_Identifier ')' CaseStmt
