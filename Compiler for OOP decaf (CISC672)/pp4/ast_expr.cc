...
void ArithmeticExpr::CheckStatements() {
 ...
 // cout << "right type: " << rt << "\n";
  if (lt && rt) // binary
    {
    	//cout << "strcmp1: " << strcmp(lt, "int") << "\n";
    	//cout << "strcmp2: " << strcmp(lt, "double") << "\n";
    	//cout << "strcmp3: " << strcmp(rt, "int") << "\n";
    	//cout << "strcmp4: " << strcmp(rt, "double") << "\n";
    	//cout << "strcmp5: " << strcmp(lt, rt) << "\n";
    	//cout << "&&: " << (strcmp(lt, "int") && strcmp(lt, "double")) << "\n";
...
const char *ArrayAccess::GetTypeName() {
  ...
  if (type) {
    //cout << "tttttttt: " << type->GetElemType()->GetTypeName() << "\n";  
  ...
  if (this->elemType)
    {
      ...
      //cout << "newArray Type: " << this->elemType->GetTypeName() << "\n";
      //printf("%s\n", str);
      return str.c_str();
    }
  else
