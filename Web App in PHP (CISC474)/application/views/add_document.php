<form id="documentForm" action="<?php echo $exepath; ?>documents/save" method="POST" onsubmit="return submitForm();">
	<input type="hidden" id="glyph" name="glyph" />
	<h1>Add New Document <a href="<?php echo $exepath; ?>documents">[Return to Document List]</a></h1>
	
	<table>
		<tr>
			<td>Title:</td>
			<td>
		      <input class="k-textbox" type="text" maxlength="100" name="title" id="title" required validationMessage="Please enter a title" />
			</td>
		</tr>
		<tr>
			<td valign="top">Content:</td>
			<td>
		      <textarea id="editor" name="content" rows="10" cols="30" style="height:440px">
		      </textarea>
			</td>
		</tr>
	</form>
