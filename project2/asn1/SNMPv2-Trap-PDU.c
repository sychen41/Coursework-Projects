...
int
SNMPv2_Trap_PDU_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
SNMPv2_Trap_PDU_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
SNMPv2_Trap_PDU_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	SNMPv2_Trap_PDU_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
SNMPv2_Trap_PDU_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
SNMPv2_Trap_PDU_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SNMPv2_Trap_PDU_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
SNMPv2_Trap_PDU_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
SNMPv2_Trap_PDU_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_SNMPv2_Trap_PDU_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_SNMPv2_Trap_PDU = {
	"SNMPv2-Trap-PDU",
	"SNMPv2-Trap-PDU",
	SNMPv2_Trap_PDU_free,
	SNMPv2_Trap_PDU_print,
	SNMPv2_Trap_PDU_constraint,
	SNMPv2_Trap_PDU_decode_ber,
	SNMPv2_Trap_PDU_encode_der,
	SNMPv2_Trap_PDU_decode_xer,
	SNMPv2_Trap_PDU_encode_xer,
